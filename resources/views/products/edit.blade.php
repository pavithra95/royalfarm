...
<div class="row" id="test">
    ...
    <div class="col-sm-10">
        <div class="form-check form-check-inline">
            <input class="form-check-input" type="checkbox" name="sale" value="1" id="tagSale" @if($product->sale) checked @endif>
            <label class="form-check-label" for="tagSale">Sale</label>
        </div>
        <div class="form-check form-check-inline">
            <input class="form-check-input" type="checkbox" name="new" value="1" id="tagNew" @if($product->new) checked @endif>
            <label class="form-check-label" for="tagNew">New</label>
        </div>
        <div class="form-check form-check-inline">
            <input class="form-check-input" type="checkbox" value="1" name="not_for_sale" id="tagNotForSale" @if($product->not_for_sale) checked @endif>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <img src="{{ asset('images/product_images/'.$product->featured_image) }}" width="50" height="50" alt="{{ $product->featured_image }}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <!-- <img src="{{ asset('images/product_images/'.$product->gallery_image[1]) }}" width="50" height="50" alt="{{ $product->featured_image }}"> -->
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="variant_type" id="variant_type_id" class="form-control" disabled>
                                    ...
                                    <option value="safety" {{ $product->variant_type == 'safety' ? 'selected' : '' }}>Simple with Multi Variable</option>
                                </select>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <img src="{{ asset('images/product_images/'.$product->s_image) }}" width="50" height="50" alt="{{ $product->s_image }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="simple_price" class="form-control" value="{{ $product->s_price }}">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="simple_discount_price">Discount Price</label>
                                        <input type="text" name="simple_discount_price" class="form-control" value="{{ $product->s_discount_price }}">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select name="simple_tax" id="" class="form-control">
                                            ...
                                            <option value="{{$tax->id}}" @if($product->tax_name==$tax->id )selected @endif>{{$tax->tax_name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select name="simple_tax_type" id="" class="form-control">
                                            <option value=""></option>
                                            <option value="inclusive" @if($product->tax_type=='inclusive')selected @endif>Inclusive</option>
                                            <!-- <option value="exclusive" @if($product->tax_type=='exclusive' )selected @endif>Exclusive</option> -->
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="simple_price">Weight</label>
                                        <input type="text" name="simple_weight" class="form-control" value="{{ $product->s_weight }}">
                                    </div>
                                </div> 
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="simple_stock">Stock</label>
                                        <input type="text" name="simple_stock" class="form-control" value="{{ $product->s_stock }}">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select name="simple_unit_id" class="form-control">
                                            ...
                                            <option value="{{$unit->id}}" @if($product->s_unit_id == $unit->id)selected @endif>{{$unit->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="tab-content">
                                                    ...
                                                    <div class="form-group" id="stock_group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select name="v_unit_id" class="form-control" id="v_unit_id">
                                                                @foreach($units as $unit)
                                                                <option value="{{$unit->id}}" @if($product->v_unit_id == $unit->id) selected @endif>{{$unit->name}}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                            ...
                                            <div class="tab-pane fade" id="tab3" role="tabpanel">
                                                ...
                                                <div class="variant-container" id="variant-{{$ps->id}}">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="o_attribute_id_tab3[]" id="attribute-select" class="form-control" disabled>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12 d-flex">
                                                        ...
                                                        <div class="col-md-2">
                                                        <div class="form-group">
                                                                <button type="button" class="btn btn-danger remove-variant" data-variant-id="{{ $ps->id }}">X</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
    ...
    <!-- <div class="d-flex flex-wrap-wrap border mb-3"> -->

        <!-- First Row -->
        <div class="row">
            @if($product->variant_type == 'safety')
                 <div class="col-md-4 price-field">
                <div class="form-group sku-group">
                    <label for="">SKU</label>
                    <input type="text" value="{{$ps->sku}}" class="form-control" name="o_skus[]">
                </div>
            </div> <div class="col-md-4 price-field">
                <div class="form-group stock-group">
                    <label for="">Stock</label>
                    <input type="text" value="{{$ps->v_stock}}" class="form-control" name="o_stock[]">
                </div>
            </div> 
           ...
           <div class="col-md-4 price-field">
                <div class="form-group">
                    ...
                    <input type="text" value="{{$ps->weight}}" class="form-control" name="o_weights[]">
                </div>
            </div>
            <div class="col-md-4 price-field">
                <div class="form-group">
                    ...
                    <input type="text" value="{{$ps->price}}" class="form-control" name="o_prices[]">
                </div>
            </div>
            <div class="col-md-4 price-field">
                <div class="form-group">
                    <label for="">Discount Price</label>
                    <input type="text" value="{{$ps->discount_price}}" class="form-control" name="o_discount_price[]">
                </div>
            </div>
        </div>
        ...
        <div class="row mt-3">
            <div class="col-md-4 price-field">
                <div class="form-group">
                    <label for="">Tax</label>
                    <select name="o_tax_name[]" id="o_tax_name" class="form-control">
                        @foreach($taxes as $tax)
                        <option value="{{$tax->id}}" @if($tax->id == $ps->tax_name) selected @endif>{{$tax->tax_name}}</option>
                        @endforeach
                    </select>
                </div>
            </div> 
            <div class="col-md-4 price-field">
                <div class="form-group">
                    ...
                    <select name="o_tax_type[]" id="o_tax_type" class="form-control">
                    <option value="inclusive" @if($ps->tax_type =='inclusive') selected @endif>Inclusive</option>
                    <!-- <option value="exclusive" @if($ps->tax_type =='exclusive') selected @endif>Exclusive</option> -->
                    </select>
                </div>
            </div>
            <div class="col-md-4 price-field">
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    $(document).ready(function() {
        ...
        $('#variant_type_id').change(function() {
            ...
            field.removeAttribute('required');
                ...
                $('#variant_type_hidden').val('safety'); // Set the hidden input value
                $('#variantForm button[type="submit"]').show(); // Show Create button
            }
            else {
              ...
              <div class="col-md-3 sku-group">
                ...
                <div class="col-md-3">
                 ...
                 <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="discount_price">Tax</label>
                                        <select name="v_tax[${rowIndex}]" id="" class="form-control" required>
                                            <option value=""></option>
                                            @foreach($taxes as $tax)
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="discount_price">Tax Type</label>
                                        <select name="v_tax_type[${rowIndex}]" id="" class="form-control" required>
                                            <option value=""></option>
    ...
    document.addEventListener('DOMContentLoaded', function() {
    // Event delegation to handle multiple remove buttons
    document.body.addEventListener('click', function(e) {
        if (e.target.classList.contains('remove-variant')) {
            const variantRow = e.target.closest('.variant-container'); // Get the closest container containing the variant
            const variantId = e.target.getAttribute('data-variant-id'); // Get the variant ID
            ...
            // AJAX request to remove the variant
            $.ajax({
                url: '/remove-variant/' + variantId,
                method: 'DELETE',
                success: function(response) {
                    // If successful, remove the variant row and reload the page
